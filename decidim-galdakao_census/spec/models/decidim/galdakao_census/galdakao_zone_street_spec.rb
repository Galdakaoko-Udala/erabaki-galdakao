...
describe Decidim::GaldakaoCensus::GaldakaoZoneStreet do
  describe "associations" do
    it "belongs to a zone" do
      zone_street = create(:galdakao_zone_street)

      expect(zone_street.zone).to be_a(Decidim::GaldakaoCensus::GaldakaoZone)
    end

    it "belongs to a street" do
      zone_street = create(:galdakao_zone_street)

      expect(zone_street.street).to be_a(Decidim::GaldakaoCensus::GaldakaoStreet)
    end
  end
