...
describe Decidim::GaldakaoCensus::Admin::CreateGaldakaoZoneStreet do
  ...
  context "when the form is not valid" do
    ...
    it "does not create a zone_street" do
      expect { command.call }.not_to change(Decidim::GaldakaoCensus::GaldakaoZoneStreet, :count)
    end
  end
  ...
  context "when the form is valid" do
    ...
    it "creates a zone_street linked to the given zone" do
      ...
      zone_street = Decidim::GaldakaoCensus::GaldakaoZoneStreet.last
    ...
    context "when the constraint requires a range" do
      ...
      it "persists the numbers_range" do
        ...
        expect(Decidim::GaldakaoCensus::GaldakaoZoneStreet.last.numbers_range).to eq("1-10")
      end
    end
    ...
    context "when the constraint does not require a range" do
      ...
      it "does not persist a numbers_range" do
        ...
        expect(Decidim::GaldakaoCensus::GaldakaoZoneStreet.last.numbers_range).to be_nil
      end
    end
  end
  ...
  context "when persisting the zone_street fails" do
    before do
      allow(Decidim::GaldakaoCensus::GaldakaoZoneStreet).to receive(:create!).and_raise(ActiveRecord::RecordInvalid.new(Decidim::GaldakaoCensus::GaldakaoZoneStreet.new))
    end
